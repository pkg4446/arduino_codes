...
void setup() {
  ...
  driver.voltage_power_supply = 13;                   //According to the supply voltage, modify the value of voltage_power_supply here
  driver.init();
  ...
  driver1.voltage_power_supply = 13;                  //Also modify the value of voltage_power_supply here
  driver1.init();
